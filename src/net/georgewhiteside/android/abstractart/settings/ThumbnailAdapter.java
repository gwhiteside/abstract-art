...
public class ThumbnailAdapter extends BaseAdapter {
	...
	public View getView4(int position, View convertView, ViewGroup parent) {
		FrameLayout frameLayout;
		
		if(convertView == null) {
			LayoutInflater layoutInflater = LayoutInflater.from(context);
			frameLayout = (FrameLayout)layoutInflater.inflate(R.layout.thumbnail_layout, parent, false);
			frameLayout.setLayoutParams(new FrameLayout.LayoutParams(thumbnailWidth, thumbnailHeight));
		} else {
		...
		ImageView imageView = (ImageView)frameLayout.findViewById(R.id.thumbnail_image);
		TextView textView = (TextView)frameLayout.findViewById(R.id.thumbnail_text);
